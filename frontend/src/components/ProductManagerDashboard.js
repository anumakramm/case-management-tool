  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="dropdown-panel">
        ...
        <label style={{ marginLeft: '20px' }}>Select Clients: </label>
        <Autocomplete
          multiple
          options={clients}
          ...
          style={{ width: 300 }}
          renderInput={(params) => <TextField {...params} label="Select Clients" placeholder="Clients" />}
        />

        {/* Assign Button */}
        <button onClick={handleAssignClients} className="ok-button" style={{ marginLeft: '20px' }}>OK</button>
